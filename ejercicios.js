...
function canBuyProduct() {
    // Tu código aquí...
    1150 >= 1500 - (1500 * 0.25) && console.log ("Puedes comprar el producto") ||
    1150 < 1500 - (1500 * 0.25) && console.log ("No puedes comprar el producto");
}
...
function logMessage() {
    // Tu código aquí...
    console.log("welcome to a new reality");
}
